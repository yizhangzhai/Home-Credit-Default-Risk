...
'SK_ID_CURR', 'SK_ID_PREV', 'INSTAL_TOTAL_NUM_INSTALMENT_NUMBER','INSTAL_EXPECTED_AMT', 'INSTAL_EXPECTED_PAY_DURATION','INSTAL_ACT_PAY_DURATION',
'INSTAL_ACT_AMT','INSTAL_EXPECTED_PAY_PER_DAY', 'INSTAL_EXPECTED_PAY_PER_TIME','INSTAL_ACT_PAY_PER_DAY', 'INSTAL_EXPECTED_PAY_INTERVAL',
'INSTAL_NUM_INSTALMENT_VERSION_nunique','INSTAL_NUM_INSTALMENT_VERSION_std', 'INSTAL_AMT_INSTALMENT_DIFF_min','INSTAL_AMT_INSTALMENT_DIFF_max',
'INSTAL_AMT_INSTALMENT_DIFF_mean','INSTAL_AMT_INSTALMENT_DIFF_std', 'INSTAL_DAYS_INSTALMENT_min','INSTAL_DAYS_INSTALMENT_max',
'INSTAL_DAYS_INSTALMENT_mean','INSTAL_DAYS_INSTALMENT_ptp', 'INSTAL_DAYS_INSTALMENT_std','INSTAL_AMT_INSTALMENT_sum', 'INSTAL_AMT_INSTALMENT_nunique',
'INSTAL_AMT_PAYMENT_sum', 'INSTAL_AMT_PAYMENT_nunique','INSTAL_DAYS_INSTALLMENT_DIFF_sum','INSTAL_DAYS_INSTALLMENT_DIFF_nunique',
'INSTAL_NUM_INSTALMENT_NUMBER_max', 'INSTAL_NUM_INSTALMENT_NUMBER_ptp','INSTAL_AMT_INSTALMENT_DIFF_IND_sum','INSTAL_AMT_INSTALMENT_DIFF_IND_nunique'
